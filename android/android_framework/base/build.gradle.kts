...
buildConfig {
    ...
    buildConfigField("String", "ACTIVITY_APP_DETAILS", provider { "\"github.tornaco.android.thanos.apps.AppDetailsActivity\"" })
    buildConfigField("String", "SU_SERVICE_CLASS", provider { "\"github.tornaco.android.thanos.service.SuSupportService\"" })
