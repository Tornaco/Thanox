...
public class FilePrinter implements Printer {
    ...
    public interface FilePrinterInterceptor {
        boolean intercept(int logLevel, String tag, String msg);
    }

    private FilePrinterInterceptor interceptor;
    ...
    public void println(int logLevel, String tag, String msg) {
        if (interceptor != null && interceptor.intercept(logLevel, tag, msg)) return;
    ...
    public static class Builder {
        ...
        public Builder interceptor(FilePrinterInterceptor interceptor) {
