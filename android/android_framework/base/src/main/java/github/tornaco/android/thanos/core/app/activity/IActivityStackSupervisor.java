...
public interface IActivityStackSupervisor extends android.os.IInterface
{
  ...
  public static class Default implements github.tornaco.android.thanos.core.app.activity.IActivityStackSupervisor
  {
    ...
    @Override public void reportRealStartActivity(android.content.Intent intent, java.lang.String reason) throws android.os.RemoteException
    {
    }
  ...
  public static abstract class Stub extends android.os.Binder implements github.tornaco.android.thanos.core.app.activity.IActivityStackSupervisor
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_reportRealStartActivity:
        {
          data.enforceInterface(descriptor);
          android.content.Intent _arg0;
          if ((0!=data.readInt())) {
          ...
          java.lang.String _arg1;
          _arg1 = data.readString();
          this.reportRealStartActivity(_arg0, _arg1);
          reply.writeNoException();
          return true;
        }
    ...
    private static class Proxy implements github.tornaco.android.thanos.core.app.activity.IActivityStackSupervisor
    {
      ...
      @Override public void reportRealStartActivity(android.content.Intent intent, java.lang.String reason) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(reason);
          boolean _status = mRemote.transact(Stub.TRANSACTION_reportRealStartActivity, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().reportRealStartActivity(intent, reason);
            return;
          }
          _reply.readException();
        }
    ...
    static final int TRANSACTION_registerTopPackageChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_unRegisterTopPackageChangeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_reportRealStartActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_isVerifyOnScreenOffEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_setVerifyOnScreenOffEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_isVerifyOnAppSwitchEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    static final int TRANSACTION_setVerifyOnAppSwitchEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
    static final int TRANSACTION_isVerifyOnTaskRemovedEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
  ...
  public void reportRealStartActivity(android.content.Intent intent, java.lang.String reason) throws android.os.RemoteException;
