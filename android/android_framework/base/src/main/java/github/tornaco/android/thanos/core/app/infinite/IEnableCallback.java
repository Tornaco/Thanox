 ...
 * Using: /Users/haoguo/Library/Android/sdk/build-tools/35.0.0/aidl -I/Users/haoguo/Documents/workspace/Thanox/android/android_framework/base/src/main/java -p/Users/haoguo/Documents/workspace/Thanox/android/android_sdk/framework.aidl -p/Users/haoguo/Documents/workspace/Thanox/android/android_sdk/thanos.aidl /Users/haoguo/Documents/workspace/Thanox/android/android_framework/base/src/main/java/github/tornaco/android/thanos/core/app/infinite/IEnableCallback.aidl
 */
package github.tornaco.android.thanos.core.app.infinite;
public interface IEnableCallback extends android.os.IInterface
{
  /** Default implementation for IEnableCallback. */
  public static class Default implements github.tornaco.android.thanos.core.app.infinite.IEnableCallback
  {
  ...
  public static abstract class Stub extends android.os.Binder implements github.tornaco.android.thanos.core.app.infinite.IEnableCallback
  {
    ...
    /**
     * Cast an IBinder object into an github.tornaco.android.thanos.core.app.infinite.IEnableCallback interface,
     * generating a proxy if needed.
     */
    public static github.tornaco.android.thanos.core.app.infinite.IEnableCallback asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof github.tornaco.android.thanos.core.app.infinite.IEnableCallback))) {
        return ((github.tornaco.android.thanos.core.app.infinite.IEnableCallback)iin);
      }
      return new github.tornaco.android.thanos.core.app.infinite.IEnableCallback.Stub.Proxy(obj);
    }
