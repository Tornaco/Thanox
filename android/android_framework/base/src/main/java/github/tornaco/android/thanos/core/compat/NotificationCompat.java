...
import github.tornaco.android.thanos.core.annotation.RestrictTo;
import github.tornaco.android.thanos.core.util.ResUtils;

import static github.tornaco.android.thanos.core.annotation.RestrictTo.Scope.LIBRARY_GROUP;
...
public class NotificationCompat {
     ...
     * with the most recent inputs that have been sent through a {@link github.tornaco.android.thanos.core.n.RemoteInput} of this
    ...
    public static class Builder {
         ...
         * through a {@link github.tornaco.android.thanos.core.n.RemoteInput} of this Notification and cleared once the it is no
    ...
    public static class Action {
        ...
        /**
         * Holds {@link github.tornaco.android.thanos.core.n.RemoteInput}s that only accept data, meaning
         * {@link github.tornaco.android.thanos.core.n.RemoteInput#getAllowFreeFormInput} is false, {@link github.tornaco.android.thanos.core.n.RemoteInput#getChoices}
         * is null or empty, and {@link github.tornaco.android.thanos.core.n.RemoteInput#getAllowedDataTypes is non-null and not
         * empty. These {@link github.tornaco.android.thanos.core.n.RemoteInput }s will be ignored by devices that do not
         * support non-text-based {@link github.tornaco.android.thanos.core.n.RemoteInput }s. See {@link Builder#build}.
         * <p>
         * You can test if a RemoteInput matches these constraints using
         * {@link github.tornaco.android.thanos.core.n.RemoteInput#isDataOnly}.
         */
        ...
        public static final class Builder {
             ...
             * {@link github.tornaco.android.thanos.core.n.RemoteInput#getResultsFromIntent} function.
             *
             * @param remoteInput a {@link github.tornaco.android.thanos.core.n.RemoteInput} to add to the action
             * @return this object for method chaining
             */
             ...
             * {@link github.tornaco.android.thanos.core.n.RemoteInput#getChoices()}. If the {@link Action} doesn't have a
             * {@link github.tornaco.android.thanos.core.n.RemoteInput}, this has no effect.
             *
    ...
    public static final class CarExtender implements Extender {
         ...
         * specified by {@link NotificationCompat.Builder#setLargeIcon(Bitmap)}
         *
