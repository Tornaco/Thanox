...
/**
 * Well-known extras used by {@link github.tornaco.android.thanos.core.compat.NotificationCompat} for backwards compatibility.
 */
@SuppressWarnings("JavadocReference")
public final class NotificationCompatExtras {
    /**
     * Extras key used internally by {@link github.tornaco.android.thanos.core.compat.NotificationCompat} to store the value of
     * the {@link android.app.Notification#FLAG_LOCAL_ONLY} field before it was available.
     * If possible, use {@link github.tornaco.android.thanos.core.compat.NotificationCompat#getLocalOnly} to access this field.
     */
    public static final String EXTRA_LOCAL_ONLY = "android.support.localOnly";

    /**
     * Extras key used internally by {@link github.tornaco.android.thanos.core.compat.NotificationCompat} to store the value set
     * by {@link android.app.Notification.Builder#setGroup} before it was available.
     * If possible, use {@link github.tornaco.android.thanos.core.compat.NotificationCompat#getGroup} to access this value.
     */
     ...
     * If possible, use {@link github.tornaco.android.thanos.core.compat.NotificationCompat#isGroupSummary} to access this value.
     */
     ...
     * If possible, use {@link github.tornaco.android.thanos.core.compat.NotificationCompat#getSortKey} to access this value.
     */
     ...
     * If possible, use {@link github.tornaco.android.thanos.core.compat.NotificationCompat#getAction} to access this field.
     */
