...
public class XmlUtils {
    ...
    public static void writeSetXml(Set val, OutputStream out) throws XmlPullParserException, IOException {
        XmlSerializer serializer = Xml.newSerializer();
        serializer.setOutput(out, StandardCharsets.UTF_8.name());
        serializer.startDocument(null, true);
        serializer.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
        writeSetXml(val, null, serializer);
        serializer.endDocument();
    }
     ...
     * @see #readThisIntArrayXml
     */
    public static void writeBooleanArrayXml(boolean[] val, String name, XmlSerializer out)
            throws XmlPullParserException, IOException {
     ...
     * @hide
     */
    public static ArrayMap<String, ?> readThisArrayMapXml(XmlPullParser parser, String endTag,
                                                          String[] name, ReadMapCallback callback)
            throws XmlPullParserException, IOException {
     ...
     */
    public static byte[] readThisByteArrayXml(XmlPullParser parser,
     ...
     * @see #readListXml
     */
    public static boolean[] readThisBooleanArrayXml(XmlPullParser parser, String endTag,
                                                    String[] name) throws XmlPullParserException, IOException {
    ...
    private static Object readThisValueXml(XmlPullParser parser, String[] name,
        ...
        if ("null".equals(tagName)) {
        ...
        } else if ("byte-array".equals(tagName)) {
            res = readThisByteArrayXml(parser, "byte-array", name);
            name[0] = valueName;
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
        } else if ("int-array".equals(tagName)) {
            res = readThisIntArrayXml(parser, "int-array", name);
            name[0] = valueName;
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
        } else if ("long-array".equals(tagName)) {
            res = readThisLongArrayXml(parser, "long-array", name);
            name[0] = valueName;
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
        } else if ("double-array".equals(tagName)) {
            ...
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
        } else if ("boolean-array".equals(tagName)) {
