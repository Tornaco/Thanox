...
/**
 * Constants that show up in and are otherwise related to {@code .dex} files, and helper methods for
 * same.
 */
public final class DexFormat {
  ...
  /**
   * API level at which the invocation of static interface methods is permitted by dx. This value
   * has been determined experimentally by testing on different VM versions.
   */
   ...
   *
   * <p>Note: Dex version 36 was loadable in some versions of Dalvik but was never fully supported
   * or completed and is not considered a valid dex file format.
   */
  public static final String VERSION_CURRENT = VERSION_FOR_API_28;
  /**
   * file name of the primary {@code .dex} file inside an application or library {@code .jar} file
   */
  ...
  /**
   * Maximum addressable type index. The largest addressable type is 0xffff, in the "instruction
   * formats" spec as type@CCCC.
   */
  ...
  /**
   * Returns the API level corresponding to the given magic number, or {@code -1} if the given array
   * is not a well-formed dex file magic number.
   *
