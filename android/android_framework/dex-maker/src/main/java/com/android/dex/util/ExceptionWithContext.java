...
public class ExceptionWithContext extends RuntimeException {
  ...
  /**
   * Augments the given exception with the given context, and return the result. The result is
   * either the given exception if it was an {@link ExceptionWithContext}, or a newly-constructed
