...
public final class InnerClassList extends FixedSizeList {
   ...
   * @param outerClass {@code null-ok;} outer class that this class is a member of, if any
   * @param innerName {@code null-ok;} original simple name of this class, if not anonymous
   * @param accessFlags original declared access flags
   */
  public void set(
      int n, CstType innerClass, CstType outerClass, CstString innerName, int accessFlags) {
