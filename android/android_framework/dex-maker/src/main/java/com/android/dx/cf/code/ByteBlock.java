...
public final class ByteBlock implements LabeledItem {
   ...
   * @param start {@code >= 0;} bytecode offset (inclusive) of the start of the block
   * @param end {@code > start;} bytecode offset (exclusive) of the end of the block
   * @param successors {@code non-null;} list of successors that this block may branch to
   * @param catches {@code non-null;} list of exceptions caught and their handler targets
   */
  ...
  public String toString() {
    return '{' + Hex.u2(label) + ": " + Hex.u2(start) + ".." + Hex.u2(end) + '}';
  }
