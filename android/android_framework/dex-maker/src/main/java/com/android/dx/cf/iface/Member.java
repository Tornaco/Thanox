...
public interface Member extends HasAttribute {
  ...
  /**
   * Get the field {@code name_index} of the member. This is just a convenient shorthand for {@code
   * getNat().getName()}.
   *
  ...
  /**
   * Get the field {@code descriptor_index} of the member. This is just a convenient shorthand for
   * {@code getNat().getDescriptor()}.
   *
  ...
  /**
   * Get the name and type associated with this member. This is a combination of the fields {@code
   * name_index} and {@code descriptor_index} in the original classfile, interpreted via the
   * constant pool.
   *
