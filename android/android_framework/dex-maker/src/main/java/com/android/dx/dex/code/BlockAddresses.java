...
/**
 * Container for the set of {@link CodeAddress} instances associated with the blocks of a particular
 * method. Each block has a corresponding start address, end address, and last instruction address.
 */
public final class BlockAddresses {
  /**
   * {@code non-null;} array containing addresses for the start of each basic block (indexed by
   * basic block label)
   */
  private final CodeAddress[] starts;

  /**
   * {@code non-null;} array containing addresses for the final instruction of each basic block
   * (indexed by basic block label)
   */
  private final CodeAddress[] lasts;

  /**
   * {@code non-null;} array containing addresses for the end (just past the final instruction) of
  ...
  /**
   * Gets the instance for the end (address after the final instruction) of the block with the given
   * label.
   *
   * @param label {@code non-null;} the label of the block in question
   * @return {@code non-null;} the appropriate instance
