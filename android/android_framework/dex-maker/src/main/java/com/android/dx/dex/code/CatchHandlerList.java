...
public final class CatchHandlerList extends FixedSizeList implements Comparable<CatchHandlerList> {
   ...
   * @param header {@code non-null;} the header for the first line (after the first prefix)
   ...
   *
   * @return {@code true} if this instance ends with a "catch-all" handler or {@code false} if not
   */
