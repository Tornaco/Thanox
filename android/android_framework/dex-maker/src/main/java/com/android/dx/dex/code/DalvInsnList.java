...
public final class DalvInsnList extends FixedSizeList {
  ...
  /**
   * The amount of register space, in register units, required for this code block. This may be
   * greater than the largest observed register+ category because the method this code block exists
   * in may specify arguments that are unused by the method.
   */
  ...
  /**
   * Gets the minimum required register count implied by this instance. This includes any unused
   * parameters that could potentially be at the top of the register space.
   *
