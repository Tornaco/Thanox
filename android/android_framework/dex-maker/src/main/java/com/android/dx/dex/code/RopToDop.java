...
/** Translator from rop-level {@link Insn} instances to corresponding {@link Dop} instances. */
public final class RopToDop {
   ...
   * @return the corresponding dalvik opcode; one of the constants in {@link Dops}
   */
