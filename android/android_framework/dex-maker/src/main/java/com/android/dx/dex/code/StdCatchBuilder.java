...
/** Constructor of {@link CatchTable} instances from {@link RopMethod} and associated data. */
public final class StdCatchBuilder implements CatchBuilder {
   ...
   * @param addresses {@code non-null;} address objects for each block
   */
  private static CatchTable.Entry makeEntry(
      BasicBlock start, BasicBlock end, CatchHandlerList handlers, BlockAddresses addresses) {
    /*
