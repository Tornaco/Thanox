...
/**
 * Pseudo-instruction base class for zero-size (no code emitted) instructions, which are generally
 * used for tracking metainformation about the code they are adjacent to.
 */
