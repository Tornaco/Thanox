...
public final class AnnotationItem extends OffsettedItem {
  ...
  /**
   * {@code non-null;} unique instance of {@link
   * TypeIdSorter}
   */
  ...
  /** {@code null-ok;} type reference for the annotation type; set during {@link #addContents} */
  ...
  /**
   * Sorts an array of instances, in place, by type id index, ignoring all other aspects of the
   * elements. This is only valid to use after type id indices are known.
   *
  ...
  /**
   * Write a (listing file) annotation for this instance to the given output, that consumes no bytes
   * of output. This is for annotating a reference to this instance at the point of the reference.
   *
