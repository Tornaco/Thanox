...
/**
 * Representation of a Dalvik class, which is basically a set of members (fields or methods) along
 * with a few more pieces of information.
 */
public final class ClassDefItem extends IndexedItem {
   ...
   * @param superclass {@code null-ok;} superclass or {@code null} if this class is a/the root class
   * @param interfaces {@code non-null;} list of implemented interfaces
   * @param sourceFile {@code null-ok;} source file name or {@code null} if unknown
   */
  public ClassDefItem(
      CstType thisClass,
      int accessFlags,
   ...
   * Gets the superclass.
   *
   * @return {@code null-ok;} the superclass or {@code null} if this class is a/the root class
   */
  ...
  /**
   * Sets the direct annotations on this class. These are annotations made on the class, per se, as
   * opposed to on one of its members. It is only valid to call this method at most once per
   * instance.
   *
  ...
  /**
   * Gets the parameter annotations for a given method, if any. This is meant for use by debugging /
   * dumping code.
   *
   * @param method {@code non-null;} the method
