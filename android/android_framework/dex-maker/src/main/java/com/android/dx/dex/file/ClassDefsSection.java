...
public final class ClassDefsSection extends UniformItemSection {
  /**
   * {@code non-null;} map from type constants for classes to {@link ClassDefItem} instances that
  ...
  /**
   * Adds an element to this instance. It is illegal to attempt to add more than one class with the
   * same name.
   *
