...
public abstract class IndexedItem extends Item {
  ...
  /**
   * Sets the item index. This method may only ever be called once per instance, and this will throw
   * a {@code RuntimeException} if called a second (or subsequent) time.
   *
