...
public final class MapItem extends OffsettedItem {
  ...
  /**
   * Constructs a self-referential instance. This instance is meant to represent the section
   * containing the {@code map_list}.
   *
   * @param section {@code non-null;} section this instance covers
   */
  ...
  /**
   * Constructs a list item with instances of this class representing the contents of the given
   * array of sections, adding it to the given map section.
   *
   * @param sections {@code non-null;} the sections
   * @param mapSection {@code non-null;} the section that the resulting map should be added to; it
   *     should be empty on entry to this method
   */
