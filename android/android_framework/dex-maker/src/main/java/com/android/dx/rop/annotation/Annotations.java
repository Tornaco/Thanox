...
public final class Annotations extends MutabilityControl implements Comparable<Annotations> {
  ...
  /**
   * Constructs an immutable instance which is the combination of the two given instances. The two
   * instances must contain disjoint sets of types.
   *
  ...
  /**
   * Constructs an immutable instance which is the combination of the given instance with the given
   * additional annotation. The latter's type must not already appear in the former.
   *
  ...
  /**
   * Adds all of the elements of the given instance to this one. The instances must not have any
   * duplicate types.
   *
