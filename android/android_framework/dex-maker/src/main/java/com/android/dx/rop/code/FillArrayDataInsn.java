...
public final class FillArrayDataInsn extends Insn {
  ...
  /**
   * non-null: type of the array. Will be used to determine the width of elements in the array-data
   * table.
   */
  ...
  public Insn withRegisterOffset(int delta) {
    return new FillArrayDataInsn(
        getOpcode(), getPosition(), getSources().withOffset(delta), initValues, arrayType);
  }
