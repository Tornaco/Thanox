...
public final class InsnList extends FixedSizeList {
  ...
  /**
   * Gets the last instruction. This is just a convenient shorthand for {@code get(size() - 1)}.
   *
  ...
  /**
   * Compares the contents of this {@code InsnList} with another. The blocks must have the same
   * number of insns, and each Insn must also return true to {@code Insn.contentEquals()}.
   *
   * @param b to compare
