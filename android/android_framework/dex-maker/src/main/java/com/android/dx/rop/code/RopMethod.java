...
public final class RopMethod {
  ...
  /**
   * {@code null-ok;} the predecessors for the implicit "exit" block, that is the labels for the
   * blocks that return, if calculated
   */
  ...
  /**
   * Gets the predecessors associated with the given block. This throws an exception if there is no
