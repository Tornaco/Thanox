...
public abstract class Constant implements ToHuman, Comparable<Constant> {
  /**
   * Returns {@code true} if this instance is a category-2 constant, meaning it takes up two slots
   * in the constant pool, or {@code false} if this instance is category-1.
   *
   ...
   * {@inheritDoc}
   *
   * <p>This compares in class-major and value-minor order.
   */
  @Override
