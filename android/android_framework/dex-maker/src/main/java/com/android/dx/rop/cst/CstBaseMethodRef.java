 ...
 *
 * <p><b>Note:</b> As a {@link TypeBearer}, this class bears the return type of the method.
 */
public abstract class CstBaseMethodRef extends CstMemberRef {
  ...
  /**
   * {@code null-ok;} the prototype for this method taken to be an instance method, or {@code null}
  ...
  /**
   * Gets the number of words of parameters required by this method's descriptor. Since instances of
   * this class have no way to know if they will be used in a {@code static} or instance context,
   * one has to indicate this explicitly as an argument. This method is just a convenient shorthand
   * for {@code getPrototype().getParameterTypes().getWordCount()}, plus {@code 1} if the method is
   * to be treated as an instance method.
   *
   * @param isStatic whether the method should be considered static
  ...
  /**
   * Gets whether this is a reference to an instance initialization method. This is just a
   * convenient shorthand for {@code getNat().isInstanceInit()}.
   *
   * @return {@code true} iff this is a reference to an instance initialization method
   */
  ...
  /**
   * Gets whether this is a reference to a class initialization method. This is just a convenient
   * shorthand for {@code getNat().isClassInit()}.
   *
   * @return {@code true} iff this is a reference to an instance initialization method
   */
  ...
  /**
   * Get whether this is a reference to a signature polymorphic method. This means it is defined in
   * {@code java.lang.invoke.MethodHandle} and is either the {@code invoke} or the {@code
   * invokeExact} method.
   *
   * @return {@code true} iff this is a reference to a signature polymorphic method.
   */
