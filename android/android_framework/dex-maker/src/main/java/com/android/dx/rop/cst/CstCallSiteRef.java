 ...
 * reference. The call site reference becomes a call site id in the DEX file and multiple call site
 * id's can refer to the same call site data.
 */
public class CstCallSiteRef extends Constant {
   ...
   * @param id a distinguishing integer for instances referring to the same {@code CstInvokeDynamic}
   *     instance
   */
