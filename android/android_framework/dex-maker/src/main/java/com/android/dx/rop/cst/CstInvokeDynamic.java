...
public final class CstInvokeDynamic extends Constant {
  ...
  /** The index of the bootstrap method in the boot method table */
   ...
   *
   * @param bootstrapMethodIndex The index of the bootstrap method in the boot method table
  ...
  /**
   * Gets the boot method index.
   *
   * @return the boot method index
   */
