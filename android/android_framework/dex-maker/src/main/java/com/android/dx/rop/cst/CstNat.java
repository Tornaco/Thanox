...
public final class CstNat extends Constant {
  /**
   * {@code non-null;} the instance for name {@code TYPE} and descriptor {@code java.lang.Class},
  ...
  /**
   * Gets the field type corresponding to this instance's descriptor. This method is only valid to
   * call if the descriptor in fact describes a field (and not a method).
   *
  ...
  /**
   * Gets whether this instance has the name of a standard instance initialization method. This is
   * just a convenient shorthand for {@code getName().getString().equals("<init>")}.
   *
  ...
  /**
   * Gets whether this instance has the name of a standard class initialization method. This is just
   * a convenient shorthand for {@code getName().getString().equals("<clinit>")}.
   *
   * @return {@code true} iff this is a reference to an instance initialization method
   */
