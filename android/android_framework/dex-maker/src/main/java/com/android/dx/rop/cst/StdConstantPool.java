...
/**
 * Standard implementation of {@link ConstantPool}, which directly stores an array of {@link
...
public final class StdConstantPool extends MutabilityControl implements ConstantPool {
   ...
   *
   * @param size the size of the pool; this corresponds to the class file field {@code
