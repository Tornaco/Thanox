 ...
 *
 * <p>See A Fast Algorithm for Finding Dominators in a Flowgraph T. Lengauer &amp; R. Tarjan, ACM
 * TOPLAS July 1979, pgs 121-141.
 *
 * <p>This implementation runs in time O(n log n). The time bound could be changed to O(n * ack(n))
 ...
 *
 * <p>The basic idea behind this algorithm is to perform a DFS walk, keeping track of various info
