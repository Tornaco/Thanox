...
/**
 * Code to figure out which local variables are active at which points in a method. Stolen and
 * retrofitted from com.android.dx.rop.code.LocalVariableExtractor
 *
 * <p>TODO remove this. Allow Rop-form LocalVariableInfo to be passed in, converted, and adapted
 * through edge-splitting.
 */
