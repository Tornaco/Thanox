...
public abstract class SsaInsn implements ToHuman, Cloneable {
   ...
   * @param block {@code non-null;} block containing this insn. Can never change.
   */
   ...
   * @return true if there is a result and it is stored in the specified register
   */
  ...
  /**
   * Sets the local association for the result of this insn. This is sometimes updated during the
   * SsaRenamer process.
   *
   ...
   *
   * <p>TODO: Move this up into NormalSsaInsn.
   *
  ...
  /**
   * Indicates whether the specified register is amongst the registers used as sources for this
   * instruction.
   *
   ...
   * <p>TODO: Move this up into NormalSsaInsn.
   *
   * @return {@code non-null;} a ROP representation of this instruction, with updated registers.
   */
  ...
  /**
   * Returns true if this insn is considered to have a side effect beyond that of assigning to the
   * result reg.
   *
   * @return true if this insn is considered to have a side effect beyond that of assigning to the
   *     result reg.
   */
  public abstract boolean hasSideEffect();

  /** @return true if this is a move (but not a move-operand or move-exception) instruction */
  public boolean isNormalMoveInsn() {
    return false;
  }

  /**
   * @return true if this is a move-exception instruction. These instructions must immediately
   *     follow a preceeding invoke*
   */
