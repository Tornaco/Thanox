...
/**
 * Allocates registers via a naive n^2 register allocator. This allocator does not try to co-locate
 * local variables or deal intelligently with different size register uses.
 */
