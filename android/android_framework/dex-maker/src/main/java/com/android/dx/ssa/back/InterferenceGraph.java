...
public class InterferenceGraph {
  /** {@code non-null;} interference graph, indexed by register in both dimensions */
  private final ArrayList<IntSet> interference;

  /**
   * Creates a new graph.
   *
   * @param countRegs {@code >= 0;} the start count of registers in the namespace. New registers can
   ...
   * @param set {@code non-null;} interference set; will be merged with set for given register
   */
