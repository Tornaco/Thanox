...
public final class Leb128 {
  ...
  /**
   * Writes {@code value} as an unsigned integer to {@code out}, starting at {@code offset}. Returns
  ...
  /**
   * Writes {@code value} as a signed integer to {@code out}, starting at {@code offset}. Returns
   * the number of bytes written.
   */
