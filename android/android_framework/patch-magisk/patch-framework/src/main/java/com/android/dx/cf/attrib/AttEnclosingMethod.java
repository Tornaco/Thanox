...
public final class AttEnclosingMethod extends BaseAttribute {
   ...
   * @param method {@code null-ok;} the name-and-type of the innermost enclosing method, if any
   */
   ...
   *
   * @return {@code null-ok;} the name-and-type of the innermost enclosing method, if any
   */
