 ...
 *
 * <p><b>Note:</b> The fields referred to in this documentation are of the {@code ClassFile}
 * structure defined in vmspec-2 sec4.1.
 */
public interface ClassFile extends HasAttribute {
  ...
  /**
   * Gets the boot method {@code attributes}.
   *
   * @return {@code non-null;} the list of boot methods
   */
  BootstrapMethodsList getBootstrapMethods();

  /**
   * Gets the name out of the {@code SourceFile} attribute of this file, if any. This is a
   * convenient shorthand for scrounging around the class's attributes.
   *
   * @return {@code non-null;} the constant pool
   */
