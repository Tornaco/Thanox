...
public interface MethodList {
  /**
   * Get whether this instance is mutable. Note that the {@code MethodList} interface itself doesn't
   * provide any means of mutation, but that doesn't mean that there isn't a non-interface way of
