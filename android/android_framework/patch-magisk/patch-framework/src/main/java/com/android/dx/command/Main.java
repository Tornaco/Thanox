...
/**
 * Main class for dx. It recognizes enough options to be able to dispatch to the right "actual"
 * boot.
 */
public class Main {
  private static final String USAGE_MESSAGE =
      "usage:\n"
          ...
          + "  [--multi-dex [--main-dex-list=<file> [--minimal-boot-dex]]\n"
          ...
          + "    --boot-dex-list=<file>: <file> is a list of class file names, classes\n"
          + "    defined by those class files are put in classes.dex.\n"
          + "    --minimal-main-dex: only classes selected by --boot-dex-list are to be put\n"
          + "    in the boot dex.\n"
