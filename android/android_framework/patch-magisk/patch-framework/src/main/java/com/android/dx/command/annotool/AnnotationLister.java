...
/**
 * Greps annotations on a set of class files and prints matching elements to stdout. What counts as
 * a match and what should be printed is controlled by the {@code Main.Arguments} instance.
 */
