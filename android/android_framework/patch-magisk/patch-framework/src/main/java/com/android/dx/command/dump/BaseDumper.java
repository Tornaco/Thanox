...
public abstract class BaseDumper implements ParseObserver {
   ...
   *
   * @param bytes {@code non-null;} bytes of the (alleged) class file on the left)
  ...
  /**
   * Gets the width of the first column of output. This is {@code 0} unless raw bytes are being
  ...
  /**
   * Combines a pair of strings as two columns, or if this is one-column output, format the
   * otherwise-second column.
   *
