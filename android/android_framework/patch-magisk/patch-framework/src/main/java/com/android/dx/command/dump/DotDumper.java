...
/**
 * Dumps the pred/succ graph of methods into a format compatible with the popular graph utility
 * "dot".
 */
public class DotDumper implements ParseObserver {
  ...
  public void endParsingMember(
    ...
    if (optimize) {
      ...
      rmeth =
          Optimizer.optimize(
              rmeth, BaseDumper.computeParamWidth(meth, isStatic), isStatic, true, advice);
    }
