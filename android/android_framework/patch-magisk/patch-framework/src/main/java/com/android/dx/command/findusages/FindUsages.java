...
public final class FindUsages {
  ...
  public FindUsages(final Dex dex, String declaredBy, String memberName, final PrintWriter out) {
    ...
    codeReader.setFieldVisitor(
        new CodeReader.Visitor() {
          @Override
  ...
  /**
   * Returns the methods with {@code memberNameIndex} declared by {@code declaringType} and its
   * subtypes.
   */
