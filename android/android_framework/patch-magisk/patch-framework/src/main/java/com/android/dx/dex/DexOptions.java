...
public final class DexOptions {
  ...
  /**
   * Does final processing of 64-bit alignment into output finisher to gets output as {@link
   * DalvInsnList} with 64-bit registers aligned at best. Disabled the final processing is required
   * for tools such as Dasm to avoid modifying user inputs.
   */
