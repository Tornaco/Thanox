...
public final class Dops {
  /**
   * pseudo-opcode used for nonstandard formatted "instructions" (which are mostly not actually
   * instructions, though they do appear in instruction lists). TODO: Retire the usage of this
   * constant.
   */
  public static final Dop SPECIAL_FORMAT =
      new Dop(
          Opcodes.SPECIAL_FORMAT,
          Opcodes.SPECIAL_FORMAT,
          Opcodes.NO_NEXT,
  ...
  public static final Dop MOVE_WIDE =
      new Dop(
          Opcodes.MOVE_WIDE, Opcodes.MOVE_WIDE, Opcodes.MOVE_WIDE_FROM16, Form12x.THE_ONE, true);
  public static final Dop MOVE_WIDE_FROM16 =
      new Dop(
          Opcodes.MOVE_WIDE_FROM16, Opcodes.MOVE_WIDE, Opcodes.MOVE_WIDE_16, Form22x.THE_ONE, true);
  ...
  public static final Dop MOVE_EXCEPTION =
      new Dop(
          Opcodes.MOVE_EXCEPTION, Opcodes.MOVE_EXCEPTION, Opcodes.NO_NEXT, Form11x.THE_ONE, true);
  ...
  public static final Dop RETURN_OBJECT =
      new Dop(
          Opcodes.RETURN_OBJECT, Opcodes.RETURN_OBJECT, Opcodes.NO_NEXT, Form11x.THE_ONE, false);
  ...
  public static final Dop CONST_STRING_JUMBO =
      new Dop(
          Opcodes.CONST_STRING_JUMBO, Opcodes.CONST_STRING, Opcodes.NO_NEXT, Form31c.THE_ONE, true);
  ...
  public static final Dop MONITOR_ENTER =
      new Dop(
          Opcodes.MONITOR_ENTER, Opcodes.MONITOR_ENTER, Opcodes.NO_NEXT, Form11x.THE_ONE, false);
  ...
  public static final Dop PACKED_SWITCH =
      new Dop(
          Opcodes.PACKED_SWITCH, Opcodes.PACKED_SWITCH, Opcodes.NO_NEXT, Form31t.THE_ONE, false);
  public static final Dop SPARSE_SWITCH =
      new Dop(
          Opcodes.SPARSE_SWITCH, Opcodes.SPARSE_SWITCH, Opcodes.NO_NEXT, Form31t.THE_ONE, false);
  ...
  public static final Dop LONG_TO_DOUBLE =
      new Dop(
          Opcodes.LONG_TO_DOUBLE, Opcodes.LONG_TO_DOUBLE, Opcodes.NO_NEXT, Form12x.THE_ONE, true);
  ...
  public static final Dop FLOAT_TO_DOUBLE =
      new Dop(
          Opcodes.FLOAT_TO_DOUBLE, Opcodes.FLOAT_TO_DOUBLE, Opcodes.NO_NEXT, Form12x.THE_ONE, true);
  ...
  public static final Dop DOUBLE_TO_LONG =
      new Dop(
          Opcodes.DOUBLE_TO_LONG, Opcodes.DOUBLE_TO_LONG, Opcodes.NO_NEXT, Form12x.THE_ONE, true);
  public static final Dop DOUBLE_TO_FLOAT =
      new Dop(
          Opcodes.DOUBLE_TO_FLOAT, Opcodes.DOUBLE_TO_FLOAT, Opcodes.NO_NEXT, Form12x.THE_ONE, true);
  ...
  public static final Dop ADD_DOUBLE_2ADDR =
      new Dop(
          Opcodes.ADD_DOUBLE_2ADDR, Opcodes.ADD_DOUBLE, Opcodes.ADD_DOUBLE, Form12x.THE_ONE, true);
  public static final Dop SUB_DOUBLE_2ADDR =
      new Dop(
          Opcodes.SUB_DOUBLE_2ADDR, Opcodes.SUB_DOUBLE, Opcodes.SUB_DOUBLE, Form12x.THE_ONE, true);
  public static final Dop MUL_DOUBLE_2ADDR =
      new Dop(
          Opcodes.MUL_DOUBLE_2ADDR, Opcodes.MUL_DOUBLE, Opcodes.MUL_DOUBLE, Form12x.THE_ONE, true);
  public static final Dop DIV_DOUBLE_2ADDR =
      new Dop(
          Opcodes.DIV_DOUBLE_2ADDR, Opcodes.DIV_DOUBLE, Opcodes.DIV_DOUBLE, Form12x.THE_ONE, true);
  public static final Dop REM_DOUBLE_2ADDR =
      new Dop(
          Opcodes.REM_DOUBLE_2ADDR, Opcodes.REM_DOUBLE, Opcodes.REM_DOUBLE, Form12x.THE_ONE, true);
   ...
   *
   * @param opcode {@code Opcodes.MIN_VALUE..Opcodes.MAX_VALUE;} the opcode value
   ...
   * @param options {@code non-null;} options, used to determine which opcodes are potentially
   *     off-limits
   * @return {@code null-ok;} the next opcode in the same family, in the chain of opcodes to try, or
   *     {@code null} if the given opcode is the last in its chain
   */
