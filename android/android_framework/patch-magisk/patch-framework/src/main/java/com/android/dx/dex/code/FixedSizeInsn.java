...
/**
 * Base class for instructions which are of a fixed code size and which use {@link InsnFormat}
 * methods to write themselves. This includes most &mdash; but not all &mdash; instructions.
 */
public abstract class FixedSizeInsn extends DalvInsn {
   ...
   * a {@code nop} or a no-argument no-result * static method call), then the given register list
   * may be passed as {@link RegisterSpecList#EMPTY}.
   *
