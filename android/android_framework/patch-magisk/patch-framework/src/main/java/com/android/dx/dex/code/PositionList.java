...
/**
 * List of source position entries. This class includes a utility method to extract an instance out
 * of a {@link DalvInsnList}.
 */
public final class PositionList extends FixedSizeList {
  ...
  /**
   * constant for {@link #make} to indicate that only "important" position information should be
   * returned. This includes block starts and instructions that might throw.
   */
