...
public final class CodeItem extends OffsettedItem {
  ...
  /**
   * {@code non-null;} list of possibly-thrown exceptions; just used in generating debugging output
   * (listings)
   */
  ...
  private void writeCodes(DexFile file, AnnotatedOutput out) {
    ...
    try {
      ...
      throw ExceptionWithContext.withContext(
          ex, "...while writing " + "instructions for " + ref.toHuman());
    }
  }
