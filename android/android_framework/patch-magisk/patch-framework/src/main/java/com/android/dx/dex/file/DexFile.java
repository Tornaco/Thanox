...
public final class DexFile {
   ...
   * MapItem#addMap} for more detail.
   */
  ...
  /**
   * Gets the {@link IndexedItem} corresponding to the given constant, if it is a constant that has
   * such a correspondence, or return {@code null} if it isn't such a constant. This will throw an
   * exception if the given constant <i>should</i> have been found but wasn't.
   *
   ...
   * ByteArrayAnnotatedOutput} instance.
   *
