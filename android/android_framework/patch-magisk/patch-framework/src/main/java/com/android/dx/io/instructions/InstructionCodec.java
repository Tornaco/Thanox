...
/**
 * Representation of an instruction format, which knows how to decode into and encode from instances
 * of {@link DecodedInstruction}.
 */
public enum InstructionCodec {
  ...
  FORMAT_20T() {
    ...
    public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
      ...
      return new ZeroRegisterDecodedInstruction(
          this, opcode, 0, null, baseAddress + target, literal);
    }
  ...
  FORMAT_22B() {
    ...
    public void encode(DecodedInstruction insn, CodeOutput out) {
      out.write(
          codeUnit(insn.getOpcode(), insn.getA()), codeUnit(insn.getB(), insn.getLiteralByte()));
    }
  },
  ...
  FORMAT_22T() {
    ...
    public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
      ...
      return new TwoRegisterDecodedInstruction(
          this, opcode, 0, null, baseAddress + target, 0L, a, b);
    }
  ...
  FORMAT_22S() {
    ...
    public void encode(DecodedInstruction insn, CodeOutput out) {
      out.write(
          codeUnit(insn.getOpcode(), makeByte(insn.getA(), insn.getB())), insn.getLiteralUnit());
    }
  },
  ...
  FORMAT_22C() {
    ...
    public void encode(DecodedInstruction insn, CodeOutput out) {
      out.write(
          codeUnit(insn.getOpcode(), makeByte(insn.getA(), insn.getB())), insn.getIndexUnit());
    }
  },
  ...
  FORMAT_22CS() {
    ...
    public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
      ...
      int index = in.read();
      return new TwoRegisterDecodedInstruction(
          this, opcode, index, IndexType.FIELD_OFFSET, 0, 0L, a, b);
    }
  ...
  FORMAT_31T() {
    ...
    public void encode(DecodedInstruction insn, CodeOutput out) {
      int relativeTarget = insn.getTarget(out.cursor());
      out.write(
          codeUnit(insn.getOpcode(), insn.getA()), unit0(relativeTarget), unit1(relativeTarget));
    }
  },
  ...
  FORMAT_45CC() {
    ...
    public void encode(DecodedInstruction insn, CodeOutput out) {
      ...
      out.write(
          codeUnit(polyInsn.getOpcode(), makeByte(polyInsn.getG(), polyInsn.getRegisterCount())),
    ...
    switch (registerCount) {
      ...
      case 3:
        return new ThreeRegisterDecodedInstruction(
            format, opcode, index, indexType, 0, 0L, a, b, c);
      case 4:
        return new FourRegisterDecodedInstruction(
            format, opcode, index, indexType, 0, 0L, a, b, c, d);
      case 5:
        return new FiveRegisterDecodedInstruction(
            format, opcode, index, indexType, 0, 0L, a, b, c, d, e);
      default: // fall out
    }
  ...
  private static void encodeRegisterList(DecodedInstruction insn, CodeOutput out) {
    out.write(
        codeUnit(insn.getOpcode(), makeByte(insn.getE(), insn.getRegisterCount())),
        insn.getIndexUnit(),
  ...
  private static void encodeRegisterRange(DecodedInstruction insn, CodeOutput out) {
    out.write(
        codeUnit(insn.getOpcode(), insn.getRegisterCount()), insn.getIndexUnit(), insn.getAUnit());
  }
  ...
  /**
   * Decodes an instruction specified by the given opcode unit, reading any required additional code
   * units from the given input source.
   */
