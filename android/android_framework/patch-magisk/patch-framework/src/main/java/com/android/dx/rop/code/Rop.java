...
public final class Rop {
   ...
   * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for no-result
   *     operations
   * @param sources {@code non-null;} types of all the sources of this operation
   * @param exceptions {@code non-null;} list of possible types thrown by this operation
   * @param branchingness the branchingness of this op; one of the {@code BRANCH_*} constants
  ...
  /**
   * Constructs an instance. The constructed instance is never a call-like op (see {@link
   * #isCallLike}).
   *
   * @param opcode the opcode; one of the constants in {@link RegOps}
   * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for no-result
  ...
  /**
   * Constructs a no-exception instance. The constructed instance is never a call-like op (see
   * {@link #isCallLike}).
   *
   * @param opcode the opcode; one of the constants in {@link RegOps}
   * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for no-result
  ...
  /**
   * Constructs a non-branching no-exception instance. The {@code branchingness} is always {@code
   * BRANCH_NONE}, and it is never a call-like op (see {@link #isCallLike}).
   *
   * @param opcode the opcode; one of the constants in {@link RegOps}
   * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for no-result
   *     operations
  ...
  /**
   * Constructs a non-empty exceptions instance. Its {@code branchingness} is always {@code
   * BRANCH_THROW}, but it is never a call-like op (see {@link #isCallLike}).
   *
   * @param opcode the opcode; one of the constants in {@link RegOps}
   * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for no-result
   *     operations
  ...
  /**
   * Constructs a non-nicknamed instance with non-empty exceptions, which is always a call-like op
   * (see {@link #isCallLike}). Its {@code branchingness} is always {@code BRANCH_THROW}.
   *
   * @param opcode the opcode; one of the constants in {@link RegOps}
   * @param sources {@code non-null;} types of all the sources of this operation
   * @param exceptions {@code non-null;} list of possible types thrown by this operation
  ...
  /**
   * Gets whether this opcode is commutative (the order of its sources are unimportant) or not. All
   * commutative Rops have exactly two sources and have no branchiness.
   *
  ...
  /**
   * Gets the nickname. If this instance has no nickname, this returns the result of calling {@link
   * #toString}.
   *
  ...
  /**
   * Gets whether this operation can possibly throw an exception. This is just a convenient wrapper
   * for {@code getExceptions().size() != 0}.
   *
