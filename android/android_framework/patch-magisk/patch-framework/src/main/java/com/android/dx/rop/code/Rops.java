...
public final class Rops {
   ...
   *
   * <p>Note that this rop-form instruction has no dex-form equivilent and must be removed before
   * the dex conversion.
   */
  ...
  /**
   * {@code T: any non-array object type; x: Object :: x instanceof T}. Note: This is listed as
   * throwing {@code Error} explicitly because the op <i>can</i> throw, but there are no other
   * predefined exceptions for it.
   */
  public static final Rop INSTANCE_OF =
      new Rop(
          RegOps.INSTANCE_OF, Type.INT, StdTypeList.OBJECT, Exceptions.LIST_Error, "instance-of");
  ...
  public static final Rop GET_STATIC_INT =
      new Rop(
          RegOps.GET_STATIC, Type.INT, StdTypeList.EMPTY, Exceptions.LIST_Error, "get-static-int");
  ...
  public static final Rop GET_STATIC_BYTE =
      new Rop(
          RegOps.GET_STATIC, Type.INT, StdTypeList.EMPTY, Exceptions.LIST_Error, "get-field-byte");

  /** {@code r: char; f: static field spec of type char :: r = f} */
  public static final Rop GET_STATIC_CHAR =
      new Rop(
          RegOps.GET_STATIC, Type.INT, StdTypeList.EMPTY, Exceptions.LIST_Error, "get-field-char");

  /** {@code r: short; f: static field spec of type short :: r = f} */
  public static final Rop GET_STATIC_SHORT =
      new Rop(
          RegOps.GET_STATIC, Type.INT, StdTypeList.EMPTY, Exceptions.LIST_Error, "get-field-short");
  ...
  public static final Rop PUT_STATIC_INT =
      new Rop(
          RegOps.PUT_STATIC, Type.VOID, StdTypeList.INT, Exceptions.LIST_Error, "put-static-int");

  /** {@code f: static field spec of type long; x: long :: f = x} */
  public static final Rop PUT_STATIC_LONG =
      new Rop(
          RegOps.PUT_STATIC, Type.VOID, StdTypeList.LONG, Exceptions.LIST_Error, "put-static-long");
  ...
  public static final Rop PUT_STATIC_BYTE =
      new Rop(
          RegOps.PUT_STATIC, Type.VOID, StdTypeList.INT, Exceptions.LIST_Error, "put-static-byte");

  /** {@code f: static field spec of type char; x: char :: f = x} */
  public static final Rop PUT_STATIC_CHAR =
      new Rop(
          RegOps.PUT_STATIC, Type.VOID, StdTypeList.INT, Exceptions.LIST_Error, "put-static-char");

  /** {@code f: static field spec of type short; x: short :: f = x} */
  public static final Rop PUT_STATIC_SHORT =
      new Rop(
          RegOps.PUT_STATIC, Type.VOID, StdTypeList.INT, Exceptions.LIST_Error, "put-static-short");
  ...
  /**
   * Returns the appropriate rop for the given opcode, destination, and sources. The result is
   * typically, but not necessarily, a shared instance.
   *
   * <p><b>Note:</b> This method does not do complete error checking on its arguments, and so it may
   * return an instance which seemed "right enough" even though in actuality the passed arguments
   * don't quite match what is returned. TODO: Revisit this issue.
   *
   * @param opcode the opcode
   * @param dest {@code non-null;} destination (result) type, or {@link Type#VOID} if none
  ...
  /**
   * Returns the appropriate {@code move-param} rop for the given type. The result is a shared
   * instance.
   *
   * @param type {@code non-null;} type of value being moved
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code move-exception} rop for the given type. The result may be a
   * shared instance.
   *
  ...
  public static Rop opMoveException(TypeBearer type) {
    return new Rop(RegOps.MOVE_EXCEPTION, type.getType(), StdTypeList.EMPTY, null);
  }

  /**
   * Returns the appropriate {@code move-result} rop for the given type. The result may be a shared
   * instance.
   *
  ...
  public static Rop opMoveResult(TypeBearer type) {
    return new Rop(RegOps.MOVE_RESULT, type.getType(), StdTypeList.EMPTY, null);
  }

  /**
   * Returns the appropriate {@code move-result-pseudo} rop for the given type. The result may be a
   * shared instance.
   *
   * @param type {@code non-null;} type of the parameter
   * @return {@code non-null;} an appropriate instance
  ...
  public static Rop opMoveResultPseudo(TypeBearer type) {
    return new Rop(RegOps.MOVE_RESULT_PSEUDO, type.getType(), StdTypeList.EMPTY, null);
  }
  ...
  /**
   * Returns the appropriate {@code if-eq} rop for the given sources. The result is a shared
   * instance.
   *
  ...
  /**
   * Returns the appropriate {@code if-ne} rop for the given sources. The result is a shared
   * instance.
   *
   * @param types {@code non-null;} source types
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code if-lt} rop for the given sources. The result is a shared
   * instance.
   *
   * @param types {@code non-null;} source types
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code if-ge} rop for the given sources. The result is a shared
   * instance.
   *
   * @param types {@code non-null;} source types
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code if-gt} rop for the given sources. The result is a shared
   * instance.
   *
   * @param types {@code non-null;} source types
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code if-le} rop for the given sources. The result is a shared
   * instance.
   *
   * @param types {@code non-null;} source types
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Helper for all the {@code if*}-related methods, which checks types and picks one of the four
   * variants, throwing if there's a problem.
   *
  ...
  public static Rop opAnd(TypeList types) {
    return pickBinaryOp(
        types, AND_CONST_INT, AND_CONST_LONG, null, null, AND_INT, AND_LONG, null, null);
  }
  ...
  public static Rop opOr(TypeList types) {
    return pickBinaryOp(
        types, OR_CONST_INT, OR_CONST_LONG, null, null, OR_INT, OR_LONG, null, null);
  }
  ...
  public static Rop opXor(TypeList types) {
    return pickBinaryOp(
        types, XOR_CONST_INT, XOR_CONST_LONG, null, null, XOR_INT, XOR_LONG, null, null);
  }
  ...
  public static Rop opShl(TypeList types) {
    return pickBinaryOp(
        types, SHL_CONST_INT, SHL_CONST_LONG, null, null, SHL_INT, SHL_LONG, null, null);
  }
  ...
  public static Rop opShr(TypeList types) {
    return pickBinaryOp(
        types, SHR_CONST_INT, SHR_CONST_LONG, null, null, SHR_INT, SHR_LONG, null, null);
  }
  ...
  public static Rop opUshr(TypeList types) {
    return pickBinaryOp(
        types, USHR_CONST_INT, USHR_CONST_LONG, null, null, USHR_INT, USHR_LONG, null, null);
  }

  /**
   * Returns the appropriate binary arithmetic rop for the given type and arguments. The result is a
   * shared instance.
   *
   ...
   * @return {@code non-null;} an appropriate instance
   */
  private static Rop pickBinaryOp(
      TypeList types,
      Rop int1,
      Rop long1,
      Rop float1,
  ...
  /**
   * Returns the appropriate {@code new-array} rop for the given type. The result is a shared
   * instance.
   *
  ...
  /**
   * Returns the appropriate {@code filled-new-array} rop for the given type. The result may be a
   * shared instance.
   *
  ...
  /**
   * Returns the appropriate {@code get-field} rop for the given type. The result is a shared
   * instance.
   *
  ...
  /**
   * Returns the appropriate {@code put-field} rop for the given type. The result is a shared
   * instance.
   *
   * @param type {@code non-null;} type of the field in question
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code get-static} rop for the given type. The result is a shared
   * instance.
   *
   * @param type {@code non-null;} type of the field in question
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code put-static} rop for the given type. The result is a shared
   * instance.
   *
   * @param type {@code non-null;} type of the field in question
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code invoke-static} rop for the given type. The result is typically a
  ...
  /**
   * Returns the appropriate {@code invoke-virtual} rop for the given type. The result is typically
  ...
  /**
   * Returns the appropriate {@code invoke-super} rop for the given type. The result is typically a
   * newly-allocated instance.
   *
   * @param meth {@code non-null;} descriptor of the method, including the {@code this} parameter
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code invoke-direct} rop for the given type. The result is typically a
   * newly-allocated instance.
   *
   * @param meth {@code non-null;} descriptor of the method, including the {@code this} parameter
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code invoke-interface} rop for the given type. The result is
  ...
  /**
   * Returns the appropriate {@code invoke-dynamic} rop for the given type. The result is typically
   * a newly-allocated instance.
   *
   * @param meth {@code non-null;} descriptor of the method, including the {@code this} parameter
   * @return {@code non-null;} an appropriate instance
  ...
  /**
   * Returns the appropriate {@code mark-local} rop for the given type. The result is a shared
   * instance.
   *
