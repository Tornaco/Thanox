...
public class CstArray extends Constant {
  ...
  public static final class List extends FixedSizeList implements Comparable<List> {
    ...
    /**
     * Gets the element at the given index. It is an error to call this with the index for an
     * element which was never set; if you do that, this will throw {@code NullPointerException}.
     *
