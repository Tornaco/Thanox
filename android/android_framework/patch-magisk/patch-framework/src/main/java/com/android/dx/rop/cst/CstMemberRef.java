...
public abstract class CstMemberRef extends TypedConstant {
   ...
   * {@inheritDoc}
   *
   * <p><b>Note:</b> This implementation just compares the defining class and name, and it is up to
   * subclasses to compare the rest after calling {@code super.compareTo0()}.
   */
  @Override
