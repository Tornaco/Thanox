...
public final class CstString extends TypedConstant {
  /** {@code non-null;} instance representing {@code ""}, that is, the empty string */
  ...
  /**
   * Converts a string into its MUTF-8 form. MUTF-8 differs from normal UTF-8 in the handling of
  ...
  /**
   * Gets the value as a human-oriented string, surrounded by double quotes, but ellipsizes the
   * result if it is longer than the given maximum length
   *
  ...
  /**
   * Gets the size of this instance as UTF-8 code points. That is, get the number of bytes in the
   * UTF-8 encoding of this instance.
   *
  ...
  /**
   * Gets the size of this instance as UTF-16 code points. That is, get the number of 16-bit chars
   * in the UTF-16 encoding of this instance. This is the same as the {@code length} of the Java
   * {@code String} representation of this instance.
   *
