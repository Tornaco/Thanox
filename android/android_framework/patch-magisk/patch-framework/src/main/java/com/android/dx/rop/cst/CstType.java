...
public final class CstType extends TypedConstant {
   ...
   */
  private static final ConcurrentMap<Type, CstType> interns = new ConcurrentHashMap<>(1_000, 0.75f);
   ...
   * primitive type. For example, if given {@link Type#INT}, this method returns the class reference
  ...
  /**
   * Gets the underlying type (as opposed to the type corresponding to this instance as a constant,
   * which is always {@code Class}).
   *
  ...
  /**
   * Returns a human readable package name for this type, like "java.util". If this is an array
   * type, this returns the package name of the array's component type. If this is a primitive type,
