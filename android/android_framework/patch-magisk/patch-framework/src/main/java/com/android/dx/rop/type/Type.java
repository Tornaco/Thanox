...
/**
 * Representation of a value type, such as may appear in a field, in a local, on a stack, or in a
 * method descriptor. Instances of this class are generally interned and may be usefully compared
 * with each other using {@code ==}.
 */
public final class Type implements TypeBearer, Comparable<Type> {
  ...
  public static final Type ANNOTATION = new Type("Ljava/lang/annotation/Annotation;", BT_OBJECT);
  ...
  /**
   * {@code non-null;} instance representing {@code java.lang.Boolean}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type BOOLEAN_CLASS = new Type("Ljava/lang/Boolean;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Byte}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type BYTE_CLASS = new Type("Ljava/lang/Byte;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Character}; the suffix on the name
   * helps disambiguate this from the instance representing a primitive type
   */
  public static final Type CHARACTER_CLASS = new Type("Ljava/lang/Character;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Double}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type DOUBLE_CLASS = new Type("Ljava/lang/Double;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Float}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type FLOAT_CLASS = new Type("Ljava/lang/Float;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Integer}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type INTEGER_CLASS = new Type("Ljava/lang/Integer;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Long}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type LONG_CLASS = new Type("Ljava/lang/Long;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Short}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  public static final Type SHORT_CLASS = new Type("Ljava/lang/Short;", BT_OBJECT);
  /**
   * {@code non-null;} instance representing {@code java.lang.Void}; the suffix on the name helps
   * disambiguate this from the instance representing a primitive type
   */
  ...
  /**
   * {@code >= -1;} for an uninitialized type, bytecode index that this instance was allocated at;
   * {@code Integer.MAX_VALUE} if it was an incoming uninitialized instance; {@code -1} if this is
   * an <i>inititialized</i> instance
   */
  private final int newAt;
  /**
   * {@code null-ok;} the internal-form class name corresponding to this type, if calculated; only
   * valid if {@code this} is a reference type and additionally not a return address
   */
  private String className;
  /** {@code null-ok;} the type corresponding to an array of this type, if calculated */
  private Type arrayType;
  /**
   * {@code null-ok;} the type corresponding to elements of this type, if calculated; only valid if
   * {@code this} is an array type
   */
  private Type componentType;
  /**
   * {@code null-ok;} the type corresponding to the initialized version of this type, if this
   * instance is in fact an uninitialized type
   */
  private Type initializedType;

  /**
   * Constructs an instance corresponding to an "uninitialized type." This is a private constructor;
   * use one of the public static methods to get instances.
   *
   * @param descriptor {@code non-null;} the field descriptor for the type
   * @param basicType basic type corresponding to this type; one of the {@code BT_*} constants
  ...
  /**
   * Constructs an instance corresponding to an "initialized type." This is a private constructor;
   * use one of the public static methods to get instances.
   *
   * @param descriptor {@code non-null;} the field descriptor for the type
   * @param basicType basic type corresponding to this type; one of the {@code BT_*} constants
  ...
  /**
   * Returns the unique instance corresponding to the type with the given descriptor. See vmspec-2
   * sec4.3.2 for details on the field descriptor syntax. This method does <i>not</i> allow {@code
   * "V"} (that is, type {@code void}) as a valid descriptor.
   *
   * @param descriptor {@code non-null;} the descriptor
   * @return {@code non-null;} the corresponding instance
   * @throws IllegalArgumentException thrown if the descriptor has invalid syntax
   */
  ...
  /**
   * Returns the unique instance corresponding to the type with the given descriptor, allowing
   * {@code "V"} to return the type for {@code void}. Other than that one caveat, this method is
   * identical to {@link #intern}.
   *
   * @param descriptor {@code non-null;} the descriptor
   * @return {@code non-null;} the corresponding instance
   * @throws IllegalArgumentException thrown if the descriptor has invalid syntax
  ...
  /**
   * Returns the unique instance corresponding to the type of the class with the given name. Calling
   * this method is equivalent to calling {@code intern(name)} if {@code name} begins with {@code
   * "["} and calling {@code intern("L" + name + ";")} in all other cases.
   *
  ...
  /**
   * Puts the given instance in the intern table if it's not already there. If a conflicting value
   * is already in the table, then leave it. Return the interned value.
   *
  ...
  /**
   * Gets the name of the class this type corresponds to, in internal form. This method is only
   * valid if this instance is for a normal reference type (that is, a reference type and
  ...
  /**
   * Gets the category. Most instances are category 1. {@code long} and {@code double} are the only
   * category 2 types.
   *
   * @return the category
   * @see #isCategory1
  ...
  /**
   * Gets whether this type is "intlike." An intlike type is one which, when placed on a stack or in
   * a local, is automatically converted to an {@code int}.
   *
  ...
  /**
   * Gets whether this type is a normal reference type. A normal reference type is a reference type
   * that is not a return address. This method is just convenient shorthand for {@code
  ...
  /**
   * Gets whether this type is an array type. If this method returns {@code true}, then it is safe
   * to use {@link #getComponentType} to determine the component type.
   *
  ...
  /**
   * Gets whether this type is an array type or is a known-null, and hence is compatible with array
   * types.
   *
   * @return whether this type is an array type
   */
  ...
  /**
   * Gets whether this type represents an uninitialized instance. An uninitialized instance is what
   * one gets back from the {@code new} opcode, and remains uninitialized until a valid constructor
   * is invoked on it.
   *
  ...
  /**
   * Gets the bytecode index at which this uninitialized type was allocated. This returns {@code
   * Integer.MAX_VALUE} if this type is an uninitialized incoming parameter (i.e., the {@code this}
   * of an {@code <init>} method) or {@code -1} if this type is in fact <i>initialized</i>.
   *
  ...
  /**
   * Gets the initialized type corresponding to this instance, but only if this instance is in fact
   * an uninitialized object type.
   *
  ...
  /**
   * Returns a new interned instance which is identical to this one, except it is indicated as
   * uninitialized and allocated at the given bytecode index. This instance must be an initialized
   * object type.
   *
