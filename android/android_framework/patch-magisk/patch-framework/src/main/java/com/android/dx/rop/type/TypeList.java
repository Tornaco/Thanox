...
public interface TypeList {
  /**
   * Returns whether this instance is mutable. Note that the {@code TypeList} interface itself
   * doesn't provide any means of mutation, but that doesn't mean that there isn't an
   ...
   * This is a sum of the widths (categories) of all the elements.
   *
  ...
  /**
   * Returns a new instance which is identical to this one, except that the given item is appended
   * to the end and it is guaranteed to be immutable.
   *
