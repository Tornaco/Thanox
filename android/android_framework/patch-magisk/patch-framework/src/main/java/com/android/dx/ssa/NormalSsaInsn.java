...
public final class NormalSsaInsn extends SsaInsn implements Cloneable {
  ...
  /**
   * Changes the source list of the insn. New source list should be the same size and consist of
   * sources of identical types.
   *
  ...
  /**
   * Upgrades this insn to a version that represents the constant source literally. If the upgrade
   * is not possible, this does nothing.
   *
   ...
   * {@inheritDoc}
   *
   * <p>TODO: Increase the scope of this.
   */
  @Override
