...
/**
 * A register allocator that maps SSA register n to Rop register 2*n, essentially preserving the
 * original mapping and remaining agnostic about normal or wide categories. Used for debugging.
 */
