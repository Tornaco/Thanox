...
public class ClassReferenceListBuilder {
  ...
  /**
   * Kept for compatibility with the gradle integration, this method just forwards to {@link
  ...
  /**
   * @param jarOfRoots Archive containing the class files resulting of the tracing, typically this
   *     is the result of running ProGuard.
   */
      ...
      if (name.endsWith(CLASS_EXTENSION)) {
        ...
        try {
          ...
          throw new IOException(
              "Class " + name + " is missing form original class path " + path, e);
        }
