...
public final class FingerprintManagerCompat {
    ...
    /**
     * Container for callback data get {@link FingerprintManagerCompat#authenticate(CryptoObject,
    ...
    private static class FlymeFingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        ...
        FlymeFingerprintManagerCompatImpl() {
            ...
            XLog.d("FUCKING FLYME!!!");
            XLog.d("USE_FLYME_SDK:" + USE_FLYME_SDK);
        }
        ...
        public void authenticate(Context context,
            ...
            if (USE_FLYME_SDK) {
                ...
                FingerprintManagerCompatApi23.authenticate(context,
                        Api23FingerprintManagerCompatImpl.wrapCryptoObject(crypto), flags,
