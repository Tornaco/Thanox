...
|    |       |    |  |
| btBoundedDevices   | List<BluetoothDevice>?      | 绑定的蓝牙设备模型列表   | 无 |
| btBoundedDeviceAddresses   | List<String>?      | 绑定的蓝牙设备地址列表   | 无 |
| btBoundedDeviceAliasNames   | List<String>?      | 绑定的蓝牙设备Alias列表   | 无 |
| btBoundedDeviceBatteryLevel   | List<String>?      | 绑定的蓝牙设备电量信息列表   | 无 |
